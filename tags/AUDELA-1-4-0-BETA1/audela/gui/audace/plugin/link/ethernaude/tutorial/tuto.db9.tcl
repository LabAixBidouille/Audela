#
# Mise a jour $Id: tuto.db9.tcl,v 1.6 2006-06-20 19:34:29 robertdelmas Exp $
#
...
Broche 8 : Bit de commande en entrée\n\
Broche 9 : SDA (I2C)\n\
\n\
...
Pin 5 : Ground\n\
Pin 6 : 5V\n\
Pin 7 : External supply voltage (9 or 12V)\n\
Pin 8 : Input command bit\n\
Pin 9 : SDA (I2C)\n\
\n\
...
.second.t insert end " \n " {demospace}
.second.t insert end "$texte(next_topic) $texte(tuto_30)" {demo demo-capot}
.second.t insert end " \n " {demospace}
.second.t insert end " \n " {demospace}
