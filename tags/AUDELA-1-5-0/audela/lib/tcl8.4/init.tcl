...
# -*- tcl -*-
# Copyright (C) 2001 ActiveState Corporation Nov 18, 2003
#
# Extension code to tcl8.4/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.4.5.0 Linux/x86, Tue Nov 18 23:27:17 PST 2003
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {linux-ix86}
	buildtime,sec {1069226837}
	buildtime,fmt {Tue Nov 18 23:27:17 PST 2003}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.4.5.0 Linux/x86, Build @buildno@ @ Tue Nov 18 23:27:17 PST 2003 / normal}
    }
}

package provide {ActiveTcl} {8.4.5.0}
