...
*   Summary of routines
*   -------------------
*   wcsfwd() and wcsrevv() are high level driver routines for the WCS linear
...
*   unknown elements.
*
*   An initialization routine, wcssett(), computes indices from the ctype
*   array but need not be called explicitly - see the explanation of
*   wcs.flag below.
*
*
*   Initialization routine; wcssett()
*   --------------------------------
...
*   it will be invoked by wcsfwd() and wcsrevv() if the "flag" structure member
...
*
*
*   Reverse transformation; wcsrevv()
*   --------------------------------
...
*         wcssett() to redetermine the indices.  The flag is set to 999 if
...
*   $Id: wcs.c,v 1.1 2005-12-07 21:55:45 denismarchais Exp $
*===========================================================================*/
...
int wcsrevv(ctype, wcs, pixcrd, lin, imgcrd, prj, phi, theta, crval, cel,
    world)
