...
typedef int (*CameraCaptureWithoutCfFunc) (Camera *camera, CameraFile *file,
					 GPContext *context);
...
struct _CameraFunctions {
	...
	CameraCaptureWithoutCfFunc   capture_without_cf;
...
int gp_camera_capture 		 (Camera *camera, CameraCaptureType type,
				  CameraFilePath *path, GPContext *context);
int gp_camera_capture_without_cf 	 (Camera *camera, CameraFile *file,
				  GPContext *context);
