...
#define SPECIFIC_CMDLIST \
    {"shuttertype", (Tcl_CmdProc *) cmdQuickaShutterType}, \
    {"ampli", (Tcl_CmdProc *) cmdQuickaAmpli}, \
    {"delayshutter", (Tcl_CmdProc *) cmdQuickaDelayshutter}, \
    {"speed", (Tcl_CmdProc *) cmdQuickaSpeed},
