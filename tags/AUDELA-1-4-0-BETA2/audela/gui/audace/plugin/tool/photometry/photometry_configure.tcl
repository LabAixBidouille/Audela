#
# Fichier : photometry_configure.tcl
# Description : Configuration de l'outil dedie a la photometrie
# Auteur : Alain Klotz
# Mise a jour $Id: photometry_configure.tcl,v 1.2 2006-08-24 21:54:33 robertdelmas Exp $
#
...
namespace eval ::photometry_configure {
   ...
   proc go { } {
      ...
      ::console::affiche_resultat "$caption(photometry,configure,titre) : \n"
   ...
   proc save { } {
      ...
      set filename [ tk_getSaveFile -title "$caption(photometry,configure,save)" -filetypes {{configuration *.photom}} -initialdir [ file join $audace(rep_plugin) tool photometry ] -parent .photometry ]
      if { $filename != "" } {
   ...
   proc load { } {
      ...
      set filename [ tk_getOpenFile -title "$caption(photometry,configure,load)" -filetypes {{configuration *.photom}} -initialdir [ file join $audace(rep_plugin) tool photometry ] -parent .photometry ]
