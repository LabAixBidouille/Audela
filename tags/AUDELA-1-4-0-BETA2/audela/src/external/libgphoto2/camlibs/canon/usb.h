 ...
 * File: usb.h
 *
 * $Id: usb.h,v 1.1 2006-12-03 09:56:41 michelpujol Exp $
 *
 ****************************************************************************/
...
int canon_usb_put_file (Camera *camera, CameraFile *file, char *destname, char *destpath, 
	        GPContext *context);
int canon_usb_capture_dialogue (Camera *camera, GPContext *context );
int canon_usb_clear_pipe (Camera *camera, GPContext *context );
