...
The stream driver can be used to efficiently read a FITS file from the
...
at least within the tolerances described below.
...
which may not be possible in the case of very large files.
...
program must conform to the following restrictions:
...
\item
Reading or writing of variable length array columns in binary
