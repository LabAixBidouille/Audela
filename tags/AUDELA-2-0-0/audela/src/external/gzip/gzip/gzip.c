...
/* --- modif for Windows compatibility --- */
#include "sysexp.h"
 ...
 */
local int do_exit(int exitcode)
/*local void do_exit(exitcode) modif Alain */
    /* int exitcode; */
{
    static int in_exit = 0;

    /*if (in_exit) exit(exitcode); modif Alain */
    if (in_exit) return(exitcode);
    in_exit = 1;
