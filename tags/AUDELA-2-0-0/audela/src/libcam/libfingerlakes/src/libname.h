 ...
 */
#define CAM_ENTRYPOINT Fingerlakes_Init
 ...
 */
#define CAM_LIBNAME "libfingerlakes"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "fingerlakes"

#define CAM_INI fingerlakes_cam_ini
#define CAM_DRV fingerlakes_cam_drv
