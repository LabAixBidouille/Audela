 ...
 */
#define CAM_ENTRYPOINT Digicam_Init
 ...
 */
#define CAM_LIBNAME "libdigicam"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "digicam"

#define CAM_INI digicam_cam_ini
#define CAM_DRV digicam_cam_drv
