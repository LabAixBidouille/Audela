 ...
 */
#define CAM_ENTRYPOINT Andorusb_Init
 ...
 */
#define CAM_LIBNAME "libandorusb"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "andorusb"

#define CAM_INI andorusb_cam_ini
#define CAM_DRV andorusb_cam_drv
