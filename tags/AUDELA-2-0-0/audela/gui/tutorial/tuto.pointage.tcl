#
# Mise à jour $Id: tuto.pointage.tcl,v 1.12 2010-06-18 17:29:22 robertdelmas Exp $
#
...
proc caption_def_firstdark { langage } {
   ...
   if {[string compare $langage english] ==0 } {
      ...
      set texte(firstdark_2) "Aiming at Celestial Objects"
      set texte(firstdark_3) "Aim your scope at the chosen object (something bright enough for a first test, i.e. a magnitude 1 star for instance) and replace the eyepiece\
with the CCD camera. Click on the red button to start an exposure. The image is probably completely out of focus and the star looks like a big circular patch with a black hole in the center. Don't panic:  this is normal!\n
This page gives you information to center the object in the field. Make several exposures while moving the scope to bring the object in the center. We are now ready to proceed to the\
focusing step.\n"
...
wm protocol .second WM_DELETE_WINDOW tuto_pointage_exit
set widgetDemo 1
