#
# Mise à jour $Id: tuto.kaf.tcl,v 1.9 2010-05-23 08:26:29 robertdelmas Exp $
#
...
"
   ...
   set texte(firstdark_3) "\
On the photo, a red circle can be seen around a jumper.\
If the jumper links the two pins, the EthernAude internal software\
must be controlling a Kaf-0401E. If the jumper\
is removed, the EthernAude software must be controlling a Kaf-1602E.\n\
"
...
wm protocol .second WM_DELETE_WINDOW tuto_kaf_exit
set widgetDemo 1
...
image$num(imageNo) configure -file [ file join $rep kaf.gif ]
...
.second.t insert end " \n " {demospace}
.second.t insert end "$texte(next_topic) $texte(tuto_32)" {demo demo-sxkey}
.second.t insert end " \n " {demospace}
.second.t insert end " \n " {demospace}
