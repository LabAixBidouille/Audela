#
# Mise à jour $Id: tuto.plug1.tcl,v 1.9 2010-05-23 08:27:45 robertdelmas Exp $
#
...
wm protocol .second WM_DELETE_WINDOW tuto_plug1_exit
set widgetDemo 1
...
image$num(imageNo) configure -file [ file join $rep ethernaude2.gif ]
