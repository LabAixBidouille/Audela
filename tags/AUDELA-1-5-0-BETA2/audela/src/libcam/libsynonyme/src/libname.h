 ...
 */
#define CAM_ENTRYPOINT Synonyme_Init
 ...
 */
#define CAM_LIBNAME "libsynonyme"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "synonyme"

#define CAM_INI synonyme_cam_ini
#define CAM_DRV synonyme_cam_drv
