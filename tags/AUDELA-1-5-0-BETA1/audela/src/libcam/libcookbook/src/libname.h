 ...
 */
#define CAM_ENTRYPOINT Cookbook_Init
 ...
 */
#define CAM_LIBNAME "libcookbook"
#define CAM_LIBVER "1.1"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "cookbook"

#define CAM_INI cookbook_cam_ini
#define CAM_DRV cookbook_cam_drv
