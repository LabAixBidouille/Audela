...
TeleAuto : http://www.astrosurf.com/teleauto (à venir)\n\
\n\
...
le fichier CCD_Driver[info sharedlibextension]. Les mises\
...
Prism : http://www.astrosurf.com/prism\n\
AudeLA : http://software.audela.free.fr\n\
TeleAuto : http://www.astrosurf.com/teleauto (to be done)\n\
\n\
These software programs have well designed image acquisition and processing\
functions.  They control the Ethernaude device using\
the CCD_Driver[info sharedlibextension] file.  Updates\
of this file can be downloaded at\
http://www.astrosurf.com/ethernaude\
"
...
#  set rep "."
#}
#image1 configure -file [ file join $rep kaf.gif ]
...
.second.t insert end " \n " {demospace}
.second.t insert end "$texte(next_topic) $texte(tuto_20)" {demo demo-rs232}
.second.t insert end " \n " {demospace}
.second.t insert end " \n " {demospace}
