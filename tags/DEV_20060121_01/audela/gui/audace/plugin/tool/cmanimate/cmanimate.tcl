...
namespace eval ::cmanim {
   ...
   proc createPanel { this } {
      ...
      if { $::tcl_platform(os) == "Linux" } {
         set panneau(cmanim,largeur_outil) "200"
      } elseif { $::tcl_platform(os) == "Darwin" } {
         set panneau(cmanim,largeur_outil) "200"
      } else {
         set panneau(cmanim,largeur_outil) "150"
      }
      #---
   ...
   proc Adapt_Panneau_AcqFC { { a "" } { b "" } { c "" } } {
      ...
      if { $panneau(cmanim,position) == "0" } {
         uplevel #0 pack forget $This.frauts.case3
         uplevel #0 pack $This.frauts.case2 -in $This.frauts -side bottom -fill none -ipadx 5 -ipady 2 -pady 2 -padx 2
         uplevel #0 pack $This.frauts.lab.but1 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack forget $This.frauts.lab.but2
         uplevel #0 pack forget $This.frauts.lab.but2.labURL1
         uplevel #0 pack forget $This.frauts.lab.but2.labURL2
         uplevel #0 pack forget $This.frauts.lab.but2.labURL3
         uplevel #0 pack forget $This.frauts.lab.but2.labURL4
         uplevel #0 pack forget $This.frauts.lab.but3
      } elseif { $panneau(cmanim,position) == "1" } {
         uplevel #0 pack forget $This.frauts.case2
         uplevel #0 pack $This.frauts.case3 -in $This.frauts -side bottom -fill none -ipadx 5 -ipady 2 -pady 2 -padx 2
         uplevel #0 pack forget $This.frauts.lab.but1
         uplevel #0 pack forget $This.frauts.lab.but2
         uplevel #0 pack forget $This.frauts.lab.but2.labURL1
         uplevel #0 pack forget $This.frauts.lab.but2.labURL2
         uplevel #0 pack forget $This.frauts.lab.but2.labURL3
         uplevel #0 pack forget $This.frauts.lab.but2.labURL4
         uplevel #0 pack $This.frauts.lab.but3 -anchor center -expand 1 -fill both -side left
      } elseif { $panneau(cmanim,position) == "2" } {
         uplevel #0 pack forget $This.frauts.case2
         uplevel #0 pack $This.frauts.case3 -in $This.frauts -side bottom -fill none -ipadx 5 -ipady 2 -pady 2 -padx 2
         uplevel #0 pack forget $This.frauts.lab.but1
         uplevel #0 pack $This.frauts.lab.but2 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack $This.frauts.lab.but2.labURL1 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack $This.frauts.lab.but2.labURL2 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack $This.frauts.lab.but2.labURL3 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack $This.frauts.lab.but2.labURL4 -anchor center -expand 1 -fill both -side left
         uplevel #0 pack forget $This.frauts.lab.but3
      }
   }
   ...
   proc pack { } {
      ...
      trace variable ::panneau(cmanim,position) w ::cmanim::Adapt_Panneau_AcqFC
      ::cmanim::Chargement_Var
      set panneau(cmanim,position) "$parametres(cmanim,position)"
      set unpackFunction ::cmanim::unpack
   ...
   proc unpack { } {
      ...
      trace vdelete ::panneau(cmanim,position) w ::cmanim::Adapt_Panneau_AcqFC
   ...
   #--- Notice the user of a wrong folder or file
	...
	uplevel #0 { pack $audace(base).position_tel.rad1 -padx 10 -pady 5 }
	...
	uplevel #0 { pack $audace(base).position_tel.rad2 -padx 10 -pady 5 }
	...
	uplevel #0 { pack $audace(base).position_tel.rad3 -padx 10 -pady 5 }
      #--- New message window is on
...
#======================
   ...
   frame $This -borderwidth 2 -height 200 -width $panneau(cmanim,largeur_outil) -borderwidth 2 -relief groove
      ...
      place $This.fra1 -x 4 -y 4 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 22 -anchor nw -bordermode ignore
      ...
      place $This.fra2 -x 4 -y 30 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 46 -anchor nw \
         -bordermode ignore
      ...
      place $This.fra3 -x 4 -y 80 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 30 -anchor nw \
         -bordermode ignore
      ...
      place $This.fra4 -x 4 -y 114 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 30 -anchor nw \
         -bordermode ignore
      ...
      place $This.fra5 -x 4 -y 148 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 30 -anchor nw \
         -bordermode ignore
      ...
      frame $This.frago -borderwidth 1 -relief groove
         ...
         pack   $This.frago.but1 -in $This.frago -side top -fill none -ipadx 5 -ipady 8 -pady 8 -padx 2

         #--- Bouton GO animate last X images
         button  $This.frago.but5 -borderwidth 2 -text "$panneau(cmanim,golast)" \
            -command { ::cmanim::cmdGolast }
         pack   $This.frago.but5 -in $This.frago -side left -fill none -ipadx 3 -ipady 3 -pady 2 -padx 4
         ...
         pack   $This.frago.ent2 -in $This.frago -side left -fill none -pady 2 -padx 2

         #--- Label for the number of last images
         label  $This.frago.lab1 -text "$panneau(cmanim,lbllast)" -relief flat
         pack   $This.frago.lab1 -in $This.frago -side left -fill none -pady 2 -padx 2

      place $This.frago -x 4 -y 182 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 100 -anchor nw \
         -bordermode ignore
      ...
      frame $This.frabrowse -borderwidth 1 -relief groove
         ...
         pack   $This.frabrowse.but2 -in $This.frabrowse -anchor center -fill none -ipadx 3 -ipady 3 -pady 8 -padx 4

         #--- Bouton Backward
         button $This.frabrowse.but3 -borderwidth 2 -text "$panneau(cmanim,backw)" \
            -command { ::cmanim::cmdBackw }
         pack   $This.frabrowse.but3 -in $This.frabrowse -anchor center -fill none -ipadx 3 -ipady 3 -pady 8 -padx 4

         #--- Button go to last image
         button $This.frabrowse.but5 -borderwidth 2 -text "$panneau(cmanim,gotolast)" \
            -command { ::cmanim::cmdGotolast }
         pack   $This.frabrowse.but5 -in $This.frabrowse -anchor center -fill none -ipadx 3 -ipady 3 -pady 8 -padx 4

         #--- Bouton Go To image
         button $This.frabrowse.but4 -borderwidth 2 -text "$panneau(cmanim,goimg)" \
            -command { ::cmanim::cmdGoto }
         pack   $This.frabrowse.but4 -in $This.frabrowse -anchor center -expand 1 -fill none -ipadx 3 -ipady 3 -side left
         ...
         entry  $This.frabrowse.ent1 -font $audace(font,arial_8_b) -textvariable panneau(cmanim,numimg) -relief groove \
            -width 4 -justify center
         pack   $This.frabrowse.ent1 -in $This.frabrowse -anchor center -expand 1 -fill none -side left

      place $This.frabrowse -x 4 -y 286 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 180 -anchor nw \
         -bordermode ignore
      ...
      frame $This.frauts -borderwidth 1 -relief groove
         ...
         pack   $This.frauts.case1 -in $This.frauts -side top -fill none -ipadx 5 -ipady 2 -pady 2 -padx 2
         ...
         frame $This.frauts.lab -borderwidth 0 -height 100 -relief groove
            ...
            pack $This.frauts.lab.but3 -in $This.frauts.lab -anchor center -expand 1 -fill both -side left \
               -expand true
         pack   $This.frauts.lab -in $This.frauts -side top -fill none -ipadx 4 -ipady 2 -pady 2 -padx 2
      place $This.frauts -x 4 -y 470 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 95 -anchor nw \
         -bordermode ignore
      ...
      place $This.fra6 -x 4 -y 569 -width [ expr $panneau(cmanim,largeur_outil) - 10 ] -height 50 -anchor nw \
         -bordermode ignore
