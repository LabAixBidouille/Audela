 ...
 * Revision 1.2  2005/06/16 19:38:10  Administrateur
 * Passage sous MACOS-X.
 *
 * Revision 1.1  2005/02/12 22:04:17  Administrateur
 * *** empty log message ***
 *
 * Revision 1.20  2004-01-04 16:54:10+01  michel
 * inversion des parametres nbcol et nbrow de loadImage( )
 *
 * Revision 1.19  2003-12-05 00:56:30+01  michel
 * suppression cmdCamStartCont
 *
 * Revision 1.18  2003-07-02 22:32:28+02  michel
 * supprime appel update_clock()
 *
 * Revision 1.17  2003-06-21 13:49:31+02  michel
 * ajout cam->authorized=1 dans cam_init
 *
 * Revision 1.16  2003-06-06 15:58:22+02  michel
 * modification variable locale ipsetting dans cam_init
 *
 * Revision 1.15  2003-06-06 15:10:33+02  michel
 * ajout setip
 *
 * Revision 1.14  2003-05-21 21:47:11+02  michel
 * execute stopContinuousAcq() si ping OK
 * desactive nice() car pas encore teste
 *
 * Revision 1.13  2003-05-11 16:50:40+02  michel
 * change la priorite de la thread pendant la lecture
 * ajoute la fonction loadImage()
 *
 * Revision 1.12  2003-04-25 14:05:49+02  michel
 * modifier   commande shutter in cam_start_exp()
 * ajouter sendHttpRequest
 * remplacer appel de socktcp_xxx par sendHttpRequest
 * ajouter startContinuousAcq, readContinuousAcq, stopContinuousAcq
 * supprimer les fonctions de test
 *
 * Revision 1.11  2003-03-26 11:44:54+01  michel
 * ajouter startScan(), scanReadLine()
 *
 * Revision 1.9  2003-01-01 11:46:20+01  michel
 * ajouter startScan(), scanReadLine()
 *
 * Revision 1.8  2002-09-30 18:32:31+02  michel
 * modif Denis pour Linux
 *
 * Revision 1.6  2002-09-04 21:46:33+02  michel
 * ajoute  ping
 * remplace setShutterOn, setShutterOff par setShutter
 *
 * Revision 1.5  2002-08-22 22:17:23+02  michel
 * ajout de la temporisation de l'envoi des paquets
 * ajout du parametre colm a getImage
 * ajout cgi-bin
 * change les parametres de socktcp_send()
 * ajout  HTTP standard
 *
 * Revision 1.4  2002-07-28 16:07:33+02  michel
 * remplacer les commentaire au format CPP en commentaire au format C
 * cam_init : supprime les parametres httpPort, udpRcvPort, udpSendport
 * shutter_on , shutter_off : nettoyage du code
 *
 * Revision 1.3  2002-07-23 20:02:46+02  michel
 * ajout parametres dans la requete de fast_vidage_inv()
 * modif code retour requete razccd
 * supprime read_tcp_win_inv()
 * supprime contenu de ampli_off () et ampli_on
 *
 * Revision 1.2  2002-06-28 22:49:12+02  michel
 * fast_vidage_inv(): replace "ABCD" by "OKOK"
 * read_udp_win_inv() : replace unsigned char data , change read last paquet, window mode
 * add shutter_on, shutter_off, ampli_on,ampli_off
 *
 * Revision 1.1  2002-04-15 16:44:38+02  michel
 * modify formule of pixel value in functions read_tcp_win_inv() and read_udp_win_inv()
 *
 * Revision 1.0  2001-12-10 15:06:18+01  michel
 * initial revision
 *
 */
