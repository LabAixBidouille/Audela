...
namespace eval confAudecomMot {
   ...
   proc createDialog { } {
      ...
      #--- De la largeur des impulsions
         ...
         label $This.lab8 -text "$conf(audecom,dlimpmin) $caption(audecomconfig,a)\
      ...
      #--- De la vitesse maxi en Dec.
         ...
         label $This.lab9 -text "$conf(audecom,dmaxdecmin) $caption(audecomconfig,a)\
      ...
      #--- De la vitesse maxi en A.D.
         ...
         label $This.lab10 -text "$conf(audecom,dmaxadmin) $caption(audecomconfig,a)\
...
namespace eval confAudecomFoc {
   ...
   proc createDialog { } {
      ...
      radiobutton $This.rad1 -anchor nw -highlightthickness 0 -padx 0 -pady 0 \
         -text "$caption(audecomconfig,intra_focal)" -value 0 -variable confAudecomFoc(audecom,intra_extra)
      ...
      radiobutton $This.rad2 -anchor nw -highlightthickness 0 -padx 0 -pady 0 \
         -text "$caption(audecomconfig,extra_focal)" -value 1 -variable confAudecomFoc(audecom,intra_extra)
...
namespace eval confAudecomKing {
   ...
   proc Clock_et_King { } {
      ...
      if { $confgene(espion2) != "1" } {
         ...
         #--- Azimut
         set confAudecomKing(azimut) [ format "%05.2f" [ lindex $pos 0 ] ]$caption(audecomconfig,degre)
         #--- Hauteur
         set confAudecomKing(hauteur) [ format "%05.2f" [ lindex $pos 1 ] ]$caption(audecomconfig,degre)
         #--- Angle horaire
...
namespace eval confAudecomMobile {
  ...
  proc createDialog { } {
     ...
     #    -text "$caption(audecomconfig,para_mobile_etoile)" \
