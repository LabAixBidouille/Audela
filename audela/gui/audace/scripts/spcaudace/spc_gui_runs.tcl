...
proc spc_calibre2loifile_w {} {
    ...
    set fcalibre [ spc_calibre2loifile $lampecalibree $spectre ]
    return $fcalibre
}
#**************************************************************************#
...
proc spc_geom2rinstrum_w {} {
    ...
    set lampe $audace(param_spc_audace,geom2rinstrum,config,etoile_ref)
    set lampe $audace(param_spc_audace,geom2rinstrum,config,etoile_cat)
...
proc spc_traite2rinstrum_w {} {
    ...
    set lampe $audace(param_spc_audace,traite2rinstrum,config,etoile_ref)
    set lampe $audace(param_spc_audace,traite2rinstrum,config,etoile_cat)
