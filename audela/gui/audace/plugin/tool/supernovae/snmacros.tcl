...
proc snPrism { } {
   ...
   buf$audace(bufNo) setkwd [list XPIXELSZ $xpixelsz              float  "X pixel size microns"         "mum"]
   buf$audace(bufNo) setkwd [list YPIXELSZ $ypixelsz              float  "Y pixel size microns"         "mum"]
