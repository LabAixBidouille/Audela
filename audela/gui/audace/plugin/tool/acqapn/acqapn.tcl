...
# Mise a jour $Id: acqapn.tcl,v 1.17 2007-05-16 20:49:30 robertdelmas Exp $
#
   ...
   #====================== Fonctions de configuration ===================================================
      ...
      proc Avance { } {
        ...
        ### if { [winfo exists $this] && $confCam(coolpix,nb_images)!="0" } { global audace ; destroy $This.avance }
