...
namespace eval obj_Lune_2 {
   ...
   #
   # obj_Lune_2::Lune_Scrolled_Canvas
   ...
   proc LitCataChoisi { } {
      ...
      ::obj_Lune_2::EffaceRectangleBleu_Rouge
   ...
   proc AfficheInfoSite { } {
      ...
      bind $zone(list_site) <ButtonRelease-1> {
         ...
         if { [string range $thissite_lune 86 89] != "    " } {
            ...
            ::obj_Lune_2::Trait_Carte_lib_et_autres
            ::obj_Lune_2::AffichePremiereCarte
            ...
            ::obj_Lune_2::ConversionNumeroCarte_lib1
            ::obj_Lune_2::ConversionNumeroCarte_lib2
            ::obj_Lune_2::AffichePremiereCarte
...
############## A developper (le site peut etre visible avec les librations)
   ...
   #
   # obj_Lune_2::Lune_Dessine_Phase_Meilleure_Date
   ...
   #
   # obj_Lune_2::affiche_cata_choisi
   ...
   proc AfficheRectangleCarteChoisie { } {
      ...
      #--- Charge les coordonnees pointees dans l'image0
      bind $zone(image0) <Motion> {
         ...
         if { ($y>"4") && ($y<"40") } {
            if { ($x>"54") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 7 108 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 7 134 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 7 161 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 7 187 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 7 214 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"245") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 7 243 38] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"23") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 26 43 55 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 43 81 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 43 108 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 43 134 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 43 161 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 43 187 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 43 214 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 43 240 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"275") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 43 273 75] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"4") && ($x<"30") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 7 80 28 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"30") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 33 80 55 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 80 81 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 80 108 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 80 134 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 80 161 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 80 187 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 80 214 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 80 240 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"269") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 80 267 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"269") && ($x<"295") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 272 80 293 110] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"4") && ($x<"30") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 7 115 28 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"30") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 33 115 55 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 115 81 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 115 108 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 115 134 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 115 161 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 165 115 187 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 115 214 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 115 240 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"269") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 115 267 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"269") && ($x<"295") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 272 115 293 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"4") && ($x<"30") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 7 151 28 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"30") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 33 151 55 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 151 81 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 151 108 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
                  ...
                  ::obj_Lune_2::DessineRectangle [list 113 151 134 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 151 161 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 151 187 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 151 214 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 151 240 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"269") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 151 267 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"269") && ($x<"295") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 272 151 293 183] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"4") && ($x<"30") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 7 188 28 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"30") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 33 188 55 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 188 81 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 188 108 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 188 134 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 188 161 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 188 187 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 188 214 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 188 240 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"269") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 188 267 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"269") && ($x<"295") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 272 188 293 219] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"23") && ($x<"57") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 27 224 55 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"57") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 60 224 81 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 224 108 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 224 134 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 224 161 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 224 187 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 224 214 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"242") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 224 240 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"242") && ($x<"275") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 245 224 274 255] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
            ...
            if { ($x>"54") && ($x<"83") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 57 260 81 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"83") && ($x<"110") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 86 260 108 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"110") && ($x<"136") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 113 260 134 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"136") && ($x<"163") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 139 260 161 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"163") && ($x<"189") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 166 260 187 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"189") && ($x<"216") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 192 260 214 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } elseif { ($x>"216") && ($x<"245") } {
               ...
               bind $zone(image0) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessineRectangle [list 219 260 243 291] $color(red)
                  ::obj_Lune_2::AfficheRepereSite
                  ::obj_Lune_2::AfficheCarteChoisie
               }
            } else {
         ...
         if { ($y>"8") && ($y<"54") } {
            if { ($x>"56") && ($x<"149") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 46 40 95 18 147 10 147 34 107 43 71 65 46 40] $color(red)
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 151 10 207 20 251 40 227 65 194 43 151 34 151 10] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } else {
            ...
            if { ($x>"10") && ($x<"56") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 12 146 22 91 41 45 66 69 43 101 34 146 12 146] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } elseif { ($x>"242") && ($x<"288") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 256 45 278 91 286 146 264 146 257 105 232 69 256 45] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } else {
            ...
            if { ($x>"10") && ($x<"56") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 42 251 21 207 12 150 34 150 42 193 66 227 42 251] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } elseif { ($x>"242") && ($x<"288") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 286 150 279 202 257 252 233 227 257 191 264 150 286 150] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } else {
            ...
            if { ($x>"56") && ($x<"149") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 147 286 95 277 47 256 72 232 104 255 147 263 147 286] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } elseif { ($x>"149") && ($x<"242") } {
               ...
               bind $zone(image4a) <ButtonPress-1> {
	            ...
	            ::obj_Lune_2::DessinePolygone [list 252 257 207 277 151 286 151 263 197 254 228 231 252 257] $color(red)
                  ::obj_Lune_2::AfficheRepereSite_lib
                  ::obj_Lune_2::AfficheCarte_libChoisie
               }
            } else {
   ...
   proc AfficheRepereSite { } {
      ...
      #--- Affichage du numero de la carte choisie
         ...
         for {set i 1} {$i <= $obj_lune(nbre_carte) } {incr i} {
            ...
            1 { ::obj_Lune_2::DessineRectangle [list 54 4 83 40] $color(blue)
              }
            2 { ::obj_Lune_2::DessineRectangle [list 83 4 110 40] $color(blue)
              }
            3 { ::obj_Lune_2::DessineRectangle [list 110 4 136 40] $color(blue)
              }
            4 { ::obj_Lune_2::DessineRectangle [list 136 4 163 40] $color(blue)
              }
            5 { ::obj_Lune_2::DessineRectangle [list 163 4 189 40] $color(blue)
              }
            6 { ::obj_Lune_2::DessineRectangle [list 189 4 216 40] $color(blue)
              }
            7 { ::obj_Lune_2::DessineRectangle [list 216 4 245 40] $color(blue)
              }
            8 { ::obj_Lune_2::DessineRectangle [list 23 40 57 77] $color(blue)
              }
            9 { ::obj_Lune_2::DessineRectangle [list 57 40 83 77] $color(blue)
              }
            10 { ::obj_Lune_2::DessineRectangle [list 83 40 110 77] $color(blue)
              }
            11 { ::obj_Lune_2::DessineRectangle [list 110 40 136 77] $color(blue)
              }
            12 { ::obj_Lune_2::DessineRectangle [list 136 40 163 77] $color(blue)
              }
            13 { ::obj_Lune_2::DessineRectangle [list 163 40 189 77] $color(blue)
              }
            14 { ::obj_Lune_2::DessineRectangle [list 189 40 216 77] $color(blue)
              }
            15 { ::obj_Lune_2::DessineRectangle [list 216 40 242 77] $color(blue)
              }
            16 { ::obj_Lune_2::DessineRectangle [list 242 40 275 77] $color(blue)
              }
            17 { ::obj_Lune_2::DessineRectangle [list 4 77 30 112] $color(blue)
              }
            18 { ::obj_Lune_2::DessineRectangle [list 30 77 57 112] $color(blue)
              }
            19 { ::obj_Lune_2::DessineRectangle [list 57 77 83 112] $color(blue)
              }
            20 { ::obj_Lune_2::DessineRectangle [list 83 77 110 112] $color(blue)
              }
            21 { ::obj_Lune_2::DessineRectangle [list 110 77 136 112] $color(blue)
              }
            22 { ::obj_Lune_2::DessineRectangle [list 136 77 163 112] $color(blue)
              }
            23 { ::obj_Lune_2::DessineRectangle [list 163 77 189 112] $color(blue)
              }
            24 { ::obj_Lune_2::DessineRectangle [list 189 77 216 112] $color(blue)
              }
            25 { ::obj_Lune_2::DessineRectangle [list 216 77 242 112] $color(blue)
              }
            26 { ::obj_Lune_2::DessineRectangle [list 242 77 269 112] $color(blue)
              }
            27 { ::obj_Lune_2::DessineRectangle [list 269 77 295 112] $color(blue)
              }
            28 { ::obj_Lune_2::DessineRectangle [list 4 112 30 148] $color(blue)
              }
            29 { ::obj_Lune_2::DessineRectangle [list 30 112 57 148] $color(blue)
              }
            30 { ::obj_Lune_2::DessineRectangle [list 57 112 83 148] $color(blue)
              }
            31 { ::obj_Lune_2::DessineRectangle [list 83 112 110 148] $color(blue)
              }
            32 { ::obj_Lune_2::DessineRectangle [list 110 112 136 148] $color(blue)
              }
            33 { ::obj_Lune_2::DessineRectangle [list 136 112 163 148] $color(blue)
              }
            34 { ::obj_Lune_2::DessineRectangle [list 163 112 189 148] $color(blue)
              }
            35 { ::obj_Lune_2::DessineRectangle [list 189 112 216 148] $color(blue)
              }
            36 { ::obj_Lune_2::DessineRectangle [list 216 112 242 148] $color(blue)
              }
            37 { ::obj_Lune_2::DessineRectangle [list 242 112 269 148] $color(blue)
              }
            38 { ::obj_Lune_2::DessineRectangle [list 269 112 295 148] $color(blue)
              }
            39 { ::obj_Lune_2::DessineRectangle [list 4 148 30 185] $color(blue)
              }
            40 { ::obj_Lune_2::DessineRectangle [list 30 148 57 185] $color(blue)
              }
            41 { ::obj_Lune_2::DessineRectangle [list 57 148 83 185] $color(blue)
              }
            42 { ::obj_Lune_2::DessineRectangle [list 83 148 110 185] $color(blue)
              }
            43 { ::obj_Lune_2::DessineRectangle [list 110 148 136 185] $color(blue)
              }
            44 { ::obj_Lune_2::DessineRectangle [list 136 148 163 185] $color(blue)
              }
            45 { ::obj_Lune_2::DessineRectangle [list 163 148 189 185] $color(blue)
              }
            46 { ::obj_Lune_2::DessineRectangle [list 189 148 216 185] $color(blue)
              }
            47 { ::obj_Lune_2::DessineRectangle [list 216 148 242 185] $color(blue)
              }
            48 { ::obj_Lune_2::DessineRectangle [list 242 148 269 185] $color(blue)
              }
            49 { ::obj_Lune_2::DessineRectangle [list 269 148 295 185] $color(blue)
              }
            50 { ::obj_Lune_2::DessineRectangle [list 4 185 30 221] $color(blue)
              }
            51 { ::obj_Lune_2::DessineRectangle [list 30 185 57 221] $color(blue)
              }
            52 { ::obj_Lune_2::DessineRectangle [list 57 185 83 221] $color(blue)
              }
            53 { ::obj_Lune_2::DessineRectangle [list 83 185 110 221] $color(blue)
              }
            54 { ::obj_Lune_2::DessineRectangle [list 110 185 136 221] $color(blue)
              }
            55 { ::obj_Lune_2::DessineRectangle [list 136 185 163 221] $color(blue)
              }
            56 { ::obj_Lune_2::DessineRectangle [list 163 185 189 221] $color(blue)
              }
            57 { ::obj_Lune_2::DessineRectangle [list 189 185 216 221] $color(blue)
              }
            58 { ::obj_Lune_2::DessineRectangle [list 216 185 242 221] $color(blue)
              }
            59 { ::obj_Lune_2::DessineRectangle [list 242 185 269 221] $color(blue)
              }
            60 { ::obj_Lune_2::DessineRectangle [list 269 185 295 221] $color(blue)
              }
            61 { ::obj_Lune_2::DessineRectangle [list 24 221 57 257] $color(blue)
              }
            62 { ::obj_Lune_2::DessineRectangle [list 57 221 83 257] $color(blue)
              }
            63 { ::obj_Lune_2::DessineRectangle [list 83 221 110 257] $color(blue)
              }
            64 { ::obj_Lune_2::DessineRectangle [list 110 221 136 257] $color(blue)
              }
            65 { ::obj_Lune_2::DessineRectangle [list 136 221 163 257] $color(blue)
              }
            66 { ::obj_Lune_2::DessineRectangle [list 163 221 189 257] $color(blue)
              }
            67 { ::obj_Lune_2::DessineRectangle [list 189 221 216 257] $color(blue)
              }
            68 { ::obj_Lune_2::DessineRectangle [list 216 221 242 257] $color(blue)
              }
            69 { ::obj_Lune_2::DessineRectangle [list 242 221 276 257] $color(blue)
              }
            70 { ::obj_Lune_2::DessineRectangle [list 54 257 83 293] $color(blue)
              }
            71 { ::obj_Lune_2::DessineRectangle [list 83 257 110 293] $color(blue)
              }
            72 { ::obj_Lune_2::DessineRectangle [list 110 257 136 293] $color(blue)
              }
            73 { ::obj_Lune_2::DessineRectangle [list 136 257 163 293] $color(blue)
              }
            74 { ::obj_Lune_2::DessineRectangle [list 163 257 189 293] $color(blue)
              }
            75 { ::obj_Lune_2::DessineRectangle [list 189 257 216 293] $color(blue)
              }
            76 { ::obj_Lune_2::DessineRectangle [list 216 257 245 293] $color(blue)
              }
	      }
         }
      }
   ...
   proc AfficheRepereSite_Bind { } {
      ...
      global frmm
         ...
         for {set i 1} {$i <= $obj_lune(nbre_carte) } {incr i} {
            ...
            1 { ::obj_Lune_2::DessineRectangle_Bind [list 57 7 81 38] $color(red)
              }
            2 { ::obj_Lune_2::DessineRectangle_Bind [list 86 7 108 38] $color(red)
              }
            3 { ::obj_Lune_2::DessineRectangle_Bind [list 113 7 134 38] $color(red)
              }
            4 { ::obj_Lune_2::DessineRectangle_Bind [list 139 7 161 38] $color(red)
              }
            5 { ::obj_Lune_2::DessineRectangle_Bind [list 166 7 187 38] $color(red)
              }
            6 { ::obj_Lune_2::DessineRectangle_Bind [list 192 7 214 38] $color(red)
              }
            7 { ::obj_Lune_2::DessineRectangle_Bind [list 219 7 243 38] $color(red)
              }
            8 { ::obj_Lune_2::DessineRectangle_Bind [list 26 43 55 75] $color(red)
              }
            9 { ::obj_Lune_2::DessineRectangle_Bind [list 60 43 81 75] $color(red)
              }
            10 { ::obj_Lune_2::DessineRectangle_Bind [list 86 43 108 75] $color(red)
              }
            11 { ::obj_Lune_2::DessineRectangle_Bind [list 113 43 134 75] $color(red)
              }
            12 { ::obj_Lune_2::DessineRectangle_Bind [list 139 43 161 75] $color(red)
              }
            13 { ::obj_Lune_2::DessineRectangle_Bind [list 166 43 187 75] $color(red)
              }
            14 { ::obj_Lune_2::DessineRectangle_Bind [list 192 43 214 75] $color(red)
              }
            15 { ::obj_Lune_2::DessineRectangle_Bind [list 219 43 240 75] $color(red)
              }
            16 { ::obj_Lune_2::DessineRectangle_Bind [list 245 43 273 75] $color(red)
              }
            17 { ::obj_Lune_2::DessineRectangle_Bind [list 7 80 28 110] $color(red)
              }
            18 { ::obj_Lune_2::DessineRectangle_Bind [list 33 80 55 110] $color(red)
              }
            19 { ::obj_Lune_2::DessineRectangle_Bind [list 60 80 81 110] $color(red)
              }
            20 { ::obj_Lune_2::DessineRectangle_Bind [list 86 80 108 110] $color(red)
              }
            21 { ::obj_Lune_2::DessineRectangle_Bind [list 113 80 134 110] $color(red)
              }
            22 { ::obj_Lune_2::DessineRectangle_Bind [list 139 80 161 110] $color(red)
              }
            23 { ::obj_Lune_2::DessineRectangle_Bind [list 166 80 187 110] $color(red)
              }
            24 { ::obj_Lune_2::DessineRectangle_Bind [list 192 80 214 110] $color(red)
              }
            25 { ::obj_Lune_2::DessineRectangle_Bind [list 219 80 240 110] $color(red)
              }
            26 { ::obj_Lune_2::DessineRectangle_Bind [list 245 80 267 110] $color(red)
              }
            27 { ::obj_Lune_2::DessineRectangle_Bind [list 272 80 293 110] $color(red)
              }
            28 { ::obj_Lune_2::DessineRectangle_Bind [list 7 115 28 146] $color(red)
              }
            29 { ::obj_Lune_2::DessineRectangle_Bind [list 33 115 55 146] $color(red)
              }
            30 { ::obj_Lune_2::DessineRectangle_Bind [list 60 115 81 146] $color(red)
              }
            31 { ::obj_Lune_2::DessineRectangle_Bind [list 86 115 108 146] $color(red)
              }
            32 { ::obj_Lune_2::DessineRectangle_Bind [list 113 115 134 146] $color(red)
              }
            33 { ::obj_Lune_2::DessineRectangle_Bind [list 139 115 161 146] $color(red)
              }
            34 { ::obj_Lune_2::DessineRectangle_Bind [list 165 115 187 146] $color(red)
              }
            35 { ::obj_Lune_2::DessineRectangle_Bind [list 192 115 214 146] $color(red)
              }
            36 { ::obj_Lune_2::DessineRectangle_Bind [list 219 115 240 146] $color(red)
              }
            37 { ::obj_Lune_2::DessineRectangle_Bind [list 245 115 267 146] $color(red)
              }
            38 { ::obj_Lune_2::DessineRectangle_Bind [list 272 115 293 146] $color(red)
              }
            39 { ::obj_Lune_2::DessineRectangle_Bind [list 7 151 28 183] $color(red)
              }
            40 { ::obj_Lune_2::DessineRectangle_Bind [list 33 151 55 183] $color(red)
              }
            41 { ::obj_Lune_2::DessineRectangle_Bind [list 60 151 81 183] $color(red)
              }
            42 { ::obj_Lune_2::DessineRectangle_Bind [list 86 151 108 183] $color(red)
              }
            43 { ::obj_Lune_2::DessineRectangle_Bind [list 113 151 134 183] $color(red)
              }
            44 { ::obj_Lune_2::DessineRectangle_Bind [list 139 151 161 183] $color(red)
              }
            45 { ::obj_Lune_2::DessineRectangle_Bind [list 166 151 187 183] $color(red)
              }
            46 { ::obj_Lune_2::DessineRectangle_Bind [list 192 151 214 183] $color(red)
              }
            47 { ::obj_Lune_2::DessineRectangle_Bind [list 219 151 240 183] $color(red)
              }
            48 { ::obj_Lune_2::DessineRectangle_Bind [list 245 151 267 183] $color(red)
              }
            49 { ::obj_Lune_2::DessineRectangle_Bind [list 272 151 293 183] $color(red)
              }
            50 { ::obj_Lune_2::DessineRectangle_Bind [list 7 188 28 219] $color(red)
              }
            51 { ::obj_Lune_2::DessineRectangle_Bind [list 33 188 55 219] $color(red)
              }
            52 { ::obj_Lune_2::DessineRectangle_Bind [list 60 188 81 219] $color(red)
              }
            53 { ::obj_Lune_2::DessineRectangle_Bind [list 86 188 108 219] $color(red)
              }
            54 { ::obj_Lune_2::DessineRectangle_Bind [list 113 188 134 219] $color(red)
              }
            55 { ::obj_Lune_2::DessineRectangle_Bind [list 139 188 161 219] $color(red)
              }
            56 { ::obj_Lune_2::DessineRectangle_Bind [list 166 188 187 219] $color(red)
              }
            57 { ::obj_Lune_2::DessineRectangle_Bind [list 192 188 214 219] $color(red)
              }
            58 { ::obj_Lune_2::DessineRectangle_Bind [list 219 188 240 219] $color(red)
              }
            59 { ::obj_Lune_2::DessineRectangle_Bind [list 245 188 267 219] $color(red)
              }
            60 { ::obj_Lune_2::DessineRectangle_Bind [list 272 188 293 219] $color(red)
              }
            61 { ::obj_Lune_2::DessineRectangle_Bind [list 27 224 55 255] $color(red)
              }
            62 { ::obj_Lune_2::DessineRectangle_Bind [list 60 224 81 255] $color(red)
              }
            63 { ::obj_Lune_2::DessineRectangle_Bind [list 86 224 108 255] $color(red)
              }
            64 { ::obj_Lune_2::DessineRectangle_Bind [list 113 224 134 255] $color(red)
              }
            65 { ::obj_Lune_2::DessineRectangle_Bind [list 139 224 161 255] $color(red)
              }
            66 { ::obj_Lune_2::DessineRectangle_Bind [list 166 224 187 255] $color(red)
              }
            67 { ::obj_Lune_2::DessineRectangle_Bind [list 192 224 214 255] $color(red)
              }
            68 { ::obj_Lune_2::DessineRectangle_Bind [list 219 224 240 255] $color(red)
              }
            69 { ::obj_Lune_2::DessineRectangle_Bind [list 245 224 274 255] $color(red)
              }
            70 { ::obj_Lune_2::DessineRectangle_Bind [list 57 260 81 291] $color(red)
              }
            71 { ::obj_Lune_2::DessineRectangle_Bind [list 86 260 108 291] $color(red)
              }
            72 { ::obj_Lune_2::DessineRectangle_Bind [list 113 260 134 291] $color(red)
              }
            73 { ::obj_Lune_2::DessineRectangle_Bind [list 139 260 161 291] $color(red)
              }
            74 { ::obj_Lune_2::DessineRectangle_Bind [list 166 260 187 291] $color(red)
              }
            75 { ::obj_Lune_2::DessineRectangle_Bind [list 192 260 214 291] $color(red)
              }
            76 { ::obj_Lune_2::DessineRectangle_Bind [list 219 260 243 291] $color(red)
              }
	      }
         }
   ...
   proc AfficheRepereSite_lib { } {
      ...
      #--- Affichage du numero de la carte de librations choisie
         ...
         for {set i 1} {$i <= $obj_lune(nbre_carte_lib) } {incr i} {
            ...
            77 { ::obj_Lune_2::DessinePolygone [list 43 40 95 16 149 8 149 36 107 45 71 67 43 40] $color(blue)
              }
            78 { ::obj_Lune_2::DessinePolygone [list 149 8 207 18 254 39 227 67 194 45 149 36 149 8] $color(blue)
              }
            79 { ::obj_Lune_2::DessinePolygone [list 256 42 280 91 288 148 262 148 255 105 229 69 256 42] $color(blue)
              }
            80 { ::obj_Lune_2::DessinePolygone [list 288 148 281 202 257 255 230 227 255 191 262 148 288 148] $color(blue)
              }
            81 { ::obj_Lune_2::DessinePolygone [list 254 257 207 279 149 288 149 261 197 252 228 229 254 257] $color(blue)
              }
            82 { ::obj_Lune_2::DessinePolygone [list 149 288 95 279 44 256 72 229 104 253 149 261 149 288] $color(blue)
              }
            83 { ::obj_Lune_2::DessinePolygone [list 42 254 19 207 10 148 36 148 44 193 69 227 42 254] $color(blue)
              }
            84 { ::obj_Lune_2::DessinePolygone [list 10 148 19 91 40 42 69 69 45 101 36 148 10 148] $color(blue)
              }
	      }
         }
      }
   ...
   proc AfficheRepereSite_lib_Bind { } {
      ...
      global frmm
         ...
         for {set i 1} {$i <= $obj_lune(nbre_carte_lib) } {incr i} {
            ...
            77 { ::obj_Lune_2::DessinePolygone_Bind [list 46 40 95 18 147 10 147 34 107 43 71 65 46 40] $color(red)
              }
            78 { ::obj_Lune_2::DessinePolygone_Bind [list 151 10 207 20 251 40 227 65 194 43 151 34 151 10] $color(red)
              }
            79 { ::obj_Lune_2::DessinePolygone_Bind [list 256 45 278 91 286 146 264 146 257 105 232 69 256 45] $color(red)
              }
            80 { ::obj_Lune_2::DessinePolygone_Bind [list 286 150 279 202 257 252 233 227 257 191 264 150 286 150] $color(red)
              }
            81 { ::obj_Lune_2::DessinePolygone_Bind [list 252 257 207 277 151 286 151 263 197 254 228 231 252 257] $color(red)
              }
            82 { ::obj_Lune_2::DessinePolygone_Bind [list 147 286 95 277 47 256 72 232 104 255 147 263 147 286] $color(red)
              }
            83 { ::obj_Lune_2::DessinePolygone_Bind [list 42 251 21 207 12 150 34 150 42 193 66 227 42 251] $color(red)
              }
            84 { ::obj_Lune_2::DessinePolygone_Bind [list 12 146 22 91 41 45 66 69 43 101 34 146 12 146] $color(red)
              }
	      }
         }
         ::obj_Lune_2::ConversionNumeroCarte_lib1_Bind
   ...
   proc EffaceRectangleBleu_Rouge { } {
      ...
      $frmm(Obj_Lune3).frame4.image0 delete cadres
   ...
   proc DessineRectangle { rect couleur } {
	...
	#--- Creation du cadre, le tag "cadres" permettra par la suite de l'effacer facilement
      $frmm(Obj_Lune3).frame4.image0 create rectangle [expr $x1] [expr $y1] \
            [expr $x2] [expr $y2] -outline $couleur -tags cadres -width 2.0
   }

   #
   # obj_Lune_2::DessineRectangle_Bind
   # Encadre la carte choisie d'un rectangle
   #
   ...
   #
   # obj_Lune_2::DessinePolygone_Bind
   # Encadre la carte choisie d'un polygone
   #
