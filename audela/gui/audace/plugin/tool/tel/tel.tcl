...
# Mise a jour $Id: tel.tcl,v 1.14 2007-11-02 23:20:50 michelpujol Exp $
#
...
namespace eval ::tlscp {
   ...
   set caption(tel,center)       "Centrage d'une étoile"
   set caption(tel,AD)           "Ascension Droite"
   set caption(tel,vitesse)      "Vitesse (ms/pixel)"
   set caption(tel,seuil)        "Seuil (pixels)"
   set caption(tel,alphaReverse) "Inverser le sens"
   set caption(tel,deltaReverse) "Inverser le sens"
   set caption(tel,declinaison)  "Déclinaison"
   set caption(tel,camera)       "Caméra"
   set caption(tel,angle)        "Angle (°)"
   set caption(tel,continu)      "Continu"
   set caption(tel,mountEnabled) "monture active"
   set caption(tel,stopccd)      "Stop CCD"
   set caption(tel,defaultSpeed) "Vitesse de centrage"
   set caption(tel,searchTitle)     "Recherche d'étoile"
   set caption(tel,searchBoxSize)   "Taille de la zone"
   set caption(tel,showSearchBox)   "Afficher la zone"
   set caption(tel,searchThreshin)  "Intensité min."
   set caption(tel,searchFwmh)      "Fwmh min."
   set caption(tel,searchRadius)    "Rayon de recherche"
   set caption(tel,searchThreshold) "Intensité min.2"
   ...
   frame $private($visuNo,This) -borderwidth 2 -relief groove
      ...
      frame $private($visuNo,This).fra1 -borderwidth 2 -relief groove
         ...
         Button $private($visuNo,This).fra1.but -borderwidth 1 -text $caption(tel,telescope) \
            -command "::audace::showHelpPlugin [::audace::getPluginTypeDirectory [::tlscp::getPluginType]] tel [::tlscp::getPluginHelp]"
      ...
      frame $private($visuNo,This).config -borderwidth 2 -relief groove
         ...
         Button $private($visuNo,This).config.but -borderwidth 1 -text "$caption(tel,configuration)..." \
      ...
      frame $private($visuNo,This).camera -borderwidth 1 -relief groove
         frame $private($visuNo,This).camera.pose
            label $private($visuNo,This).camera.pose.label -text "$caption(tel,pose)"
            ...
            button $private($visuNo,This).camera.pose.webcam -text "$caption(tel,pose)" \
...
#
#            label $private($visuNo,This).camera.fra1.lab1 -text $caption(tel,seconde) -relief flat
...
#         pack $private($visuNo,This).camera.fra1 -in $private($visuNo,This).camera -side top -fill x
         ...
         frame $private($visuNo,This).camera.optionmenu1 -borderwidth 0 -relief groove
            menubutton $private($visuNo,This).camera.optionmenu1.but_bin -text $caption(tel,binning) \
         ...
         #--- Bouton GO
         button $private($visuNo,This).camera.goccd -borderwidth 2 -text $caption(tel,goccd) \
         ...
         #--- checkbutton continu
        checkbutton $private($visuNo,This).camera.continu -text "$caption(tel,continu)" \
         -variable ::conf(tlscp,continuousAcquisition)
         #--- checkbutton monture active
        checkbutton $private($visuNo,This).camera.mountEnabled -text "$caption(tel,mountEnabled)" \
...
proc ::tlscp::center::startAcquisition { visuNo mode } {
   ...
   $::tlscp::private($visuNo,This).camera.goccd configure -text "$::caption(tel,stopccd) (ESC)" -command "::tlscp::center::stopAcquisition $visuNo"
...
proc ::tlscp::center::stopAcquisition { visuNo } {
   ...
   if { $private($visuNo,acquisitionState) == 1 } {
      ...
      $::tlscp::private($visuNo,This).camera.goccd configure -text $::caption(tel,goccd) -command "::tlscp::center::startAcquisition $visuNo acq"
...
#------------------------------------------------------------
# ::tlscp::center::processAcquisition2
#
...
proc ::tlscp::config::getLabel { } {
   ...
   return "[::tlscp::getPluginTitle] $caption(tel,configuration)"
}
...
proc ::tlscp::config::fillConfigPage { frm visuNo } {
   ...
   TitleFrame $frm.alpha -borderwidth 2 -relief ridge -text "$caption(tel,AD)"
      LabelEntry $frm.alpha.gainprop -label "$caption(tel,vitesse)" \
      ...
      LabelEntry $frm.alpha.seuil -label "$caption(tel,seuil)" \
         -labeljustify left -labelwidth 16 -width 5 -justify right \
      ...
      checkbutton $frm.alpha.reverse -text "$caption(tel,alphaReverse)" \
   ...
   #--- Frame declinaison
   TitleFrame $frm.delta -borderwidth 2 -text "$caption(tel,declinaison)"
      LabelEntry $frm.delta.gainprop -label "$caption(tel,vitesse)" \
         -labeljustify left -labelwidth 16 -width 5 -justify right \
...
##         -validate all -validatecommand { ::tlscp::validateNumber %W %V %P %s -9999 9999}
      ...
      LabelEntry $frm.delta.seuil -label "$caption(tel,seuil)" \
         -labeljustify left -labelwidth 16 -width 5 -justify right \
         -validate all -validatecommand { ::tlscp::validateNumber %W %V %P %s 0 99} \
      ...
      checkbutton $frm.delta.reverse -text "$caption(tel,deltaReverse)" \
   ...
   #--- Frame camera
   TitleFrame $frm.camera -borderwidth 2 -text "$caption(tel,camera)"
      LabelEntry $frm.camera.angle -label "$caption(tel,angle)" \
   ...
   #--- Frame telescope
   TitleFrame $frm.telescope -borderwidth 2 -text "$caption(tel,telescope)"
      label $frm.telescope.speedLabel -text "$caption(tel,defaultSpeed)"
   ...
   #--- Frame search
   TitleFrame $frm.search -borderwidth 2 -text "$caption(tel,searchTitle)"
      LabelEntry $frm.search.searchBoxSize -label $caption(tel,searchBoxSize) \
      ...
      checkbutton $frm.search.showSearchBox -text "$caption(tel,showSearchBox)" \
      ...
      LabelEntry $frm.search.threshin -label "$caption(tel,searchThreshin)" \
      ...
      LabelEntry $frm.search.fwhm -label "$caption(tel,searchFwmh)" \
         -labeljustify left -labelwidth 22 -width 3 -justify right \
      ...
      LabelEntry $frm.search.radius -label "$caption(tel,searchRadius)" \
         -labeljustify left -labelwidth 22 -width 3 -justify right \
      ...
      LabelEntry $frm.search.threshold -label "$caption(tel,searchThreshold)" \
         -labeljustify left -labelwidth 22 -width 3 -justify right \
