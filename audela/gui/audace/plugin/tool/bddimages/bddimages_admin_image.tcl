...
namespace eval bddimages_admin_image {
   ...
   proc ::bddimages_admin_image::add_info_cata { img_list } {
      ...
      foreach img $img_list {
         set idbddimg [::bddimages_admin_image::get_key_img idbddimg $img]
         if {$cpt == 0} {
   ...
   proc ::bddimages_admin_image::get_key_img { key img } {
