#
# Mise à jour $Id: tuto.sxkeyio.tcl,v 1.9 2010-05-23 08:33:38 robertdelmas Exp $
#
...
wm protocol .second WM_DELETE_WINDOW tuto_sxkeyio_exit
set widgetDemo 1
...
image$num(imageNo) configure -file [ file join $rep sxkeyio.gif ]
