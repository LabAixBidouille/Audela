...
# calibwcs2  in out number Angle_ra Angle_dec pixsize1_mu pixsize2_mu foclen_m USNO|MICROCAT cat_folder ?first_index?
...
proc simulimage {args} {
   if {[llength $args] >= 5} {
      ...
      incr k ; set newstar_dec 0          ; if {[llength $args] >= [expr 1+$k]} { set newstar_dec [lindex $args $k] }
