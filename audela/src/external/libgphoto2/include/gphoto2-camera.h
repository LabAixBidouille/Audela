...
typedef int (*CameraCaptureImageFunc) (Camera *camera, CameraFile *file,
					 GPContext *context);
...
struct _CameraFunctions {
	...
	CameraCaptureImageFunc   capture_image;
...
int gp_camera_capture 		 (Camera *camera, CameraCaptureType type,
				  CameraFilePath *path, GPContext *context);
int gp_camera_capture_image 	 (Camera *camera, CameraFile *file,
				  GPContext *context);
