...
namespace eval ::selectWindow {
   ...
   proc run { } {
      ...
      frame $This.fra2.f -bd 2 -relief groove
         ...
         entry $This.fra2.f.ene -width 15 -textvariable selectWindow(nomEntree)
         button $This.fra2.f.explore -text "$caption(select,parcourir)" -width 1 -command { ::selectWindow::parcourir 1 }
         label $This.fra2.f.lie -text "$caption(select,index)"
         entry $This.fra2.f.eie -width 3 -textvariable selectWindow(indexEntree)
         grid $This.fra2.f.titre -row 0 -column 0 -columnspan 2 -sticky {}
         grid $This.fra2.f.lne -row 1 -column 0 -sticky w
         grid $This.fra2.f.ene -row 1 -column 1 -sticky e
         grid $This.fra2.f.explore -row 1 -column 2 -sticky e -padx 10 -ipady 5
         grid $This.fra2.f.lie -row 2 -column 0 -sticky w
         grid $This.fra2.f.eie -row 2 -column 1 -sticky e

      frame $This.fra2.g -bd 2 -relief groove
         label $This.fra2.g.titre -text "$caption(select,sortie)"
         label $This.fra2.g.lne -text "$caption(select,nom)"
         entry $This.fra2.g.ene -width 15 -textvariable selectWindow(nomSortie)
         button $This.fra2.g.explore -text "$caption(select,parcourir)" -width 1 -command { ::selectWindow::parcourir 2 }
         label $This.fra2.g.lie -text "$caption(select,index)"
         entry $This.fra2.g.eie -width 3 -textvariable selectWindow(indexSortie)
         grid $This.fra2.g.titre -row 0 -column 0 -columnspan 2 -sticky {}
         grid $This.fra2.g.lne -row 1 -column 0 -sticky w
         grid $This.fra2.g.ene -row 1 -column 1 -sticky e
         grid $This.fra2.g.explore -row 1 -column 2 -sticky e -padx 10 -ipady 5
         grid $This.fra2.g.lie -row 2 -column 0 -sticky w
         grid $This.fra2.g.eie -row 2 -column 1 -sticky e

      frame $This.fra2.h -bd 2 -relief groove
         button $This.fra2.h.b0 -text "$caption(select,demarrer)" -command { ::selectWindow::start }
         button $This.fra2.h.b1 -text "$caption(select,inf)" -command { ::selectWindow::prev } -state disabled
         entry  $This.fra2.h.e0 -textvariable selectWindow(indexEntree) -width 3
         button $This.fra2.h.b2 -text "$caption(select,sup)" -command { ::selectWindow::next } -state disabled
         button $This.fra2.h.b4 -text "$caption(select,auto)" -command { ::selectWindow::auto } -state disabled
         button $This.fra2.h.b5 -text "$caption(select,aide)" -command { ::selectWindow::afficheAide } -state normal
         button $This.fra2.h.b3 -text "$caption(select,record)" -command { ::selectWindow::record } -state disabled
         pack $This.fra2.h.b0 $This.fra2.h.b1 $This.fra2.h.e0 $This.fra2.h.b2 $This.fra2.h.b4 -side left -padx 4 -pady 4 -ipady 5
         pack $This.fra2.h.b3 $This.fra2.h.b5 -side right -padx 4 -pady 4 -ipady 5

      frame $This.fra2.i
         text $This.fra2.i.t -yscrollcommand "$This.fra2.i.vsb set" -xscrollcommand "$This.fra2.i.hsb set" -width 0 -height 0
         scrollbar $This.fra2.i.vsb -orient vertical -command "$This.fra2.i.t yview"
         scrollbar $This.fra2.i.hsb -orient horizontal -command "$This.fra2.i.t xview"
         grid $This.fra2.i.t $This.fra2.i.vsb -sticky news
         grid $This.fra2.i.hsb -sticky ew
         grid rowconfigure $This.fra2.i 0 -weight 1
         grid columnconfigure $This.fra2.i 0 -weight 1
   ...
   proc auto { } {
      ...
      if { ( $selectWindow(nomSortie) != "" ) && ( $selectWindow(indexSortie) != "" ) } {
         ...
         $This.fra2.i.t insert insert "# $liste\n\n"
         ...
         foreach elem $liste {
            ...
            $This.fra2.i.t insert insert "file copy -force $org $dest\n\n"
   ...
   proc record { } {
      ...
      if { ( $selectWindow(nomSortie) != "" ) && ( $selectWindow(indexSortie) != "" ) } {
         $This.fra2.h.b3 configure -state disabled
         set cmp [ buf$selectWindow(buffer) compress ]
         if { $cmp == "none" } {
            set cmp ""
         } else {
   ...
   proc dispima { index } {
      ...
      if { $index >= "0" } {
         ...
         if { $selectWindow(index) == "0" } {
            ...
            $This.fra2.h.b1 configure -state normal
         }
      }
   }
