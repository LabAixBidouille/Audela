...
namespace eval ::param_spc_audace_calibre2file {
   ...
   proc run { {positionxy 20+20} } {
      ...
      wm geometry .param_spc_audace_calibre2file 300x350+30+30
...
namespace eval ::param_spc_audace_geom2calibre {
   ...
   proc run { {positionxy 20+20} } {
      ...
      wm geometry .param_spc_audace_geom2calibre 450x324+30+30
...
namespace eval ::param_spc_audace_geom2rinstrum {
   ...
   proc run { {positionxy 20+20} } {
      ...
      wm geometry .param_spc_audace_geom2rinstrum 450x425+30+30
...
namespace eval ::param_spc_audace_traite2calibre {
   ...
   proc run { {positionxy 20+20} } {
      ...
      wm geometry .param_spc_audace_traite2calibre 450x420+30+30
...
namespace eval ::param_spc_audace_traite2rinstrum {
   ...
   proc run { {positionxy 20+20} } {
      ...
      wm geometry .param_spc_audace_traite2rinstrum 450x515+30+30
  ...
  proc go {} {
      ...
      set listeargs [ list $brut $noir $plu $noirplu $offset $lampe $etoile_ref $etoile_cat $methreg $methcos $methsel $methsky $methinv $methbin $methnorma $methsmo ]

      #--- Lancement de la fonction spcaudace :
      #-- Si tous les champs sont /= "" on execute le calcul :
      if { [ spc_testguiargs $listeargs ] == 1 } {
	  set fileout [ spc_traite2rinstrum $brut $noir $plu $noirplu $offset $lampe $etoile_ref $etoile_cat $methreg $methcos $methsel $methsky $methinv $methbin $methnorma $methsmo ]
	  destroy .param_spc_audace_traite2rinstrum
	  return $fileout
      }
  }
...
namespace eval ::param_spc_audace_geom2rinstrum {
   ...
   proc run { {positionxy 20+20} } {
      ...
      #--- Cree la fenetre .param_spc_audace_geom2rinstrum de niveau le plus haut
      toplevel .param_spc_audace_geom2rinstrum -class Toplevel -bg $audace(param_spc_audace,geom2rinstrum,color,backpad)
      wm geometry .param_spc_audace_geom2rinstrum 450x420+30+30
      wm resizable .param_spc_audace_geom2rinstrum 1 1
      wm title .param_spc_audace_geom2rinstrum $caption(param_spc_audace,geom2rinstrum,titre)
      wm protocol .param_spc_audace_geom2rinstrum WM_DELETE_WINDOW "::param_spc_audace_geom2rinstrum::annuler"
...
namespace eval ::param_spc_audace_traite2calibre {
   ...
   proc run { {positionxy 20+20} } {
      ...
      #--- Cree la fenetre .param_spc_audace_traite2calibre de niveau le plus haut
      toplevel .param_spc_audace_traite2calibre -class Toplevel -bg $audace(param_spc_audace,traite2calibre,color,backpad)
      wm geometry .param_spc_audace_traite2calibre 450x425+30+30
      wm resizable .param_spc_audace_traite2calibre 1 1
      wm title .param_spc_audace_traite2calibre $caption(param_spc_audace,traite2calibre,titre)
      wm protocol .param_spc_audace_traite2calibre WM_DELETE_WINDOW "::param_spc_audace_traite2calibre::annuler"
...
# Auteurs : Benjamin Mauclaire
# Date de création : 14-07-2006
# Date de modification : 28-08-2006
# Utilisée par : spc_traite2rinstrum
...
namespace eval ::param_spc_audace_traite2srinstrum {
   ...
   proc run { {positionxy 20+20} } {
      ...
      set caption(param_spc_audace,traite2srinstrum,config,lampe) "Spectre de lampe de calibration"
      set caption(param_spc_audace,traite2srinstrum,config,rinstrum) "Spectre de la réponse intrumentale"
      ...
      wm geometry .param_spc_audace_traite2srinstrum 450x475+30+30
  ...
  proc go {} {
      ...
      set listeargs [ list $brut $noir $plu $noirplu $offset $lampe $rinstrum $methreg $methcos $methsel $methsky $methinv $methbin $methnorma $methsmo ]

      #--- Lancement de la fonction spcaudace :
      #-- Si tous les champs sont /= "" on execute le calcul :
      if { [ spc_testguiargs $listeargs ] == 1 } {
	  set fileout [ spc_traite2srinstrum $brut $noir $plu $noirplu $offset $lampe $rinstrum $methreg $methcos $methsel $methsky $methinv $methbin $methnorma $methsmo ]
	  destroy .param_spc_audace_traite2srinstrum
	  return $fileout
      }
  }
