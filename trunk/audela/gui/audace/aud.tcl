...
# Mise a jour $Id: aud.tcl,v 1.117 2010-01-03 18:49:36 robertdelmas Exp $
...
namespace eval ::audace {
   ...
   proc createMenu { } {
      ...
      Menu_Command   $visuNo "$caption(audace,menu,configuration)" "$caption(audace,menu,logiciels_externes)..." \
