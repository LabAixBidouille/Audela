...
proc snPrism { } {
   ...
   buf$audace(bufNo) setkwd [list XPIXELSZ $xpixelsz              float  "X pixel size micron"          "mum"]
   buf$audace(bufNo) setkwd [list YPIXELSZ $ypixelsz              float  "Y pixel size micron"          "mum"]
