...
#--- create buttons
button $base.btn.ok -text "$caption(telshift,ok)" -command Run
button $base.btn.annuler -text "$caption(telshift,annuler)" -command Close
button $base.btn.help1 -text "$caption(telshift,aide)" -command Open
...
#--- set up key binding
bind $base.btn.ok <Return> Run
bind $base.btn.annuler <Escape> Close
