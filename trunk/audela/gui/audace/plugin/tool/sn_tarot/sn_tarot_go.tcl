...
proc ::sn_tarot::sn_tarotStart { } {
   ...
   set dir $panneau(init_dir)
   foreach sub_path [ list archives night dss ] {
   ...
   #--
   foreach { prefix url var } [ list \
     "Tarot_Calern" $panneau(sn_tarot,Tarot_Calern,url) calern \
     "Tarot_Chili" $panneau(sn_tarot,Tarot_Chili,url) chili ] {
