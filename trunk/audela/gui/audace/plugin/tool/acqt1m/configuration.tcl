...
#
   ...
   proc ::t1m_roue_a_filtre::init_roue { } {
      ...
      set ::t1m_roue_a_filtre::private(filtre,5) [list 0  "up_sloan" "Us"     0   1   0.1   0.2   0.]
      set ::t1m_roue_a_filtre::private(filtre,6) [list 0  "gp_sloan" "Gs"     0   5   0.1   0.2   0.]
      set ::t1m_roue_a_filtre::private(filtre,7) [list 0  "rp_sloan" "Rs"     0   4   0.1   0.2   0.]
      set ::t1m_roue_a_filtre::private(filtre,8) [list 0  "ip_sloan" "Is"     0   3   0.1   0.2   0.]
      set ::t1m_roue_a_filtre::private(filtre,9) [list 0  "zp_sloan" "Zs"     0   2   0.1   0.2   0.]
