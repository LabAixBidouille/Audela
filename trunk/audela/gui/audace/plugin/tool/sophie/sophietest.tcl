...
##-----------------------------------------------------------
# @brief    Proc�dures de test de l'outil sophie et simulation des interfaces externes
#
#------------------------------------------------------------
namespace eval ::sophie::test {
   ...
   set private(controlThreadId) ""
      ...
      # @param     Argv[13]=findFiber           1=recherche de l'entr�e de fibre , 0= ne pas rechercher
      ...
      #            list[1] starX                abcisse du centre de la fibre   (pixel binn�)
      #            list[2] starY                ordonnee du centre de la fibre  (pixel binn�
      #            list[3] fiberStatus          resultat de la recherche de la fibre (DETECTED NO_SIGNAL)
      #            list[4] fiberX               abcisse du centre de la fibre  (pixel binn�)
      #            list[5] fiberY               ordonnee du centre de la fibre (pixel binn�)
      #            list[6] measuredFwhmX        gaussienne mesuree (pixel binn�)
      #            list[7] measuredFwhmY        gaussienne mesuree (pixel binn�)
...
proc ::sophie::test::connecterPcGuidage { } {
   ...
   set catchError [ catch {
      if { $private(pcSophie,socketChannel) == "" } {
         ...
         $private(frm).pcsophie.connect configure -text "d�connecter"
      } else {
         ::sophie::test::closeSocketSophie
...
proc ::sophie::test::connectTelescopeControl { } {
   ...
   set catchError [ catch {
      if { $private(controlThreadId) == "" } {
         ...
         $private(frm).pccontrol.connect configure -text "d�connecter"
      } else {
