...
#============================================================
   ...
   proc createPanel { this } {
      ...
      if { $::tcl_platform(os) == "Linux" } {
         set panneau(cmaude,largeur_outil) "180"
      } elseif { $::tcl_platform(os) == "Darwin" } {
         set panneau(cmaude,largeur_outil) "180"
      } else {
         set panneau(cmaude,largeur_outil) "150"
      }
      #---
   ...
   proc pack { } {
      ...
      set unpackFunction ::cmaude::unpack
   ...
   #--- Fonction of acquisition
	...
	if { $panneau(cmaude,binning) == "1x1" } then {
	   ...
	   window $cmconf(win11)
	   #--- Mirror operation to have North on top and East on the right (as on TCS)
        # mirrorx
...
global color
   ...
   #--- Frame of panel
   frame $This -borderwidth 2 -height 99 -width $panneau(cmaude,largeur_outil) -borderwidth 2 -relief groove
      ...
      place $This.fra1 -x 4 -y 4 -width [ expr $panneau(cmaude,largeur_outil) - 10 ] -height 22 -anchor nw \
         -bordermode ignore
      ...
      frame $This.fra2 -borderwidth 1 -relief groove
         ...
         pack   $This.fra2.ent1 -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4
         ...
         pack   $This.fra2.ent2 -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4
         ...
         pack   $This.fra2.ent2a -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4

         #--- Label for the name of image
         label  $This.fra2.lab3 -text "$panneau(cmaude,label_nom)" -relief flat
         pack   $This.fra2.lab3 -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4
         #--- Entry for the name of image
         entry  $This.fra2.ent3 -font $audace(font,arial_7_b) -textvariable panneau(cmaude,nom) -relief groove
         pack   $This.fra2.ent3 -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4
	   ...
	   #--- Menu for the binning
         ...
         pack $This.fra2.but_binning -in $This.fra2 -anchor center -pady 2 -padx 4 -ipadx 3
         ...
         pack   $This.fra2.ent5 -in $This.fra2 -anchor center -pady 2 -padx 4

         #--- Label for the rythm
         label  $This.fra2.lab6 -text "$panneau(cmaude,label_rythm)" -relief flat
         pack   $This.fra2.lab6 -in $This.fra2 -anchor center -expand 1 -fill both -pady 2 -padx 4
         #--- Entry for the rythm
         entry  $This.fra2.ent6 -font $audace(font,arial_8_b) -textvariable panneau(cmaude,rythm) \
            -width 5 -relief groove -justify center
         pack   $This.fra2.ent6 -in $This.fra2 -anchor center -pady 2 -padx 4
      ...
      place $This.fra2 -x 4 -y 32 -width [ expr $panneau(cmaude,largeur_outil) - 10 ] -height 466 -anchor nw \
         -bordermode ignore
      ...
      place $This.fra3 -x 4 -y 504 -width [ expr $panneau(cmaude,largeur_outil) - 10 ] -height 110 -anchor nw \
         -bordermode ignore
