...
int tt_ima_series_5_offset_toto(TT_IMA_SERIES *pseries);
...
/**************************************************************************/
{
   if (strcmp(keys10,"OFFSET_TOTO")==0) { pseries->numfct=TT_IMASERIES_USER5_OFFSET_TOTO; }
   return(OK_DLL);
}
...
/*****************************************************************************/
{
   if (pseries->numfct==TT_IMASERIES_USER5_OFFSET_TOTO) {
      *msg=tt_ima_series_5_offset_toto(pseries);
      *fct_found=TT_YES;
   }
   return(OK_DLL);
}
