...
# ADD CPP /nologo /MTd /W3 /GX /Zi /I "..\src" /I "..\..\..\include" /I "..\..\..\external\include\win" /I "..\..\..\external\porttalk" /I "..\..\..\external\include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "USE_TCL_STUBS" /D "USE_TK_STUBS" /D "USE_COMPOSITELESS_PHOTO_PUT_BLOCK" /D "USE_COMPAT_CONST" /FR /Fo".\Debug/" /Fd".\Debug/" /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib  advapi32.lib  tkstub84.lib tclstub84.lib wsock32.lib version.lib libdcraw.lib libdcjpeg.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"msvcrt" /out:"..\..\..\..\bin\libaudela.dll " /pdbtype:sept /libpath:"..\..\..\external\lib"
