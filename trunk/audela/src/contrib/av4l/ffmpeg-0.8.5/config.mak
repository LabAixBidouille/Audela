...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-pic --enable-shared --enable-static --disable-doc --disable-pthreads --disable-network --disable-outdevs --disable-indevs --enable-indev=v4l2 --disable-protocols --enable-protocol=file --disable-encoders --enable-encoder=ffvhuff --enable-encoder=huffyuv --enable-encoder=rawvideo --disable-decoders --enable-decoder=ffvhuff --enable-decoder=huffyuv --enable-decoder=rawvideo --disable-muxers --enable-muxer=avi --disable-demuxers --enable-demuxer=avi --disable-bsfs --disable-parsers --disable-yasm
prefix=/usr/local
...
SRC_PATH="/data/install/develop/audela/src/contrib/av4l/ffmpeg-0.8.5"
SRC_PATH_BARE=/data/install/develop/audela/src/contrib/av4l/ffmpeg-0.8.5
CC_IDENT=gcc 4.5 (SUSE Linux)
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
ACODEC_TESTS=aref 
VCODEC_TESTS=flashsv2 huffyuv msvideo1 qtrle qtrlegray rgb vref yuv 
LAVF_TESTS=avi voc_s16 
