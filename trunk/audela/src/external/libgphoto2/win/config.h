...
#define LTDL_SYSSEARCHPATH "/lib:/usr/lib:/usr/lib/graphviz:/usr/X11R6/lib:/usr/lib/qt3/lib"
...
#define dlopen(_filename)		LoadLibrary(_filename)
#define dlsym(_handle, _funcname)	GetProcAddress(_handle, _funcname)
#define dlclose(_handle)		FreeLibrary(_handle)
