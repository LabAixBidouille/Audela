...
#define PXMAX_IRBGF	7	/* worst case # of pximage structs required	*/ 
...
struct pxdevinfo { 
    ...
    uint32  memsize;	    /* frame buffer memory size, per unit	    */ 
...
struct pxdevservice { 
     ...
     */ 
    int (_cfunfcc *getImap)	 (pxdevservice_s *me,int options,int unitmap,uint32 adrs,uint altspace,void _farimap **accessp,ulong *accesslen); 
    int (_cfunfcc *freeImap)	 (pxdevservice_s *me,int options,int unitmap,uint32 adrs,uint altspace,void _farimap **accessp,ulong *accesslen); 
    int (_cfunfcc *io)		 (pxdevservice_s *me,int options,int unitmap,uint32 adrs,uint altspace,void *buf,uint cnt,uint rw,pxasync_s *async,pxtimespec_s *time); 
  //int (_cfunfcc *iosparse)	 (pxdevservice_s *me,int options,int unitmap,uint32 adrs,uint altspace,void *buf,uint cnt,uint rw,pxasync_s *async,pxtimespec_s *time,uint blksize,uint blkpitch); 
...
struct pxauxservice { 
    ...
    int (_cfunfcc *imageReadUChar)  (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry, 
				     uchar *membuf,int cnt,int colorspace,int colormap,int iomode,int iodata); 
    ...
    int (_cfunfcc *imageReadUShort) (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry, 
				     ushort *membuf,int cnt,int colorspace,int colormap,int iomode,int iodata); 
    ...
    int (_cfunfcc *imageReadUInt)   (pxauxservice_s *me,int options,int unitmap,int stateid,pxbuffer_t framebuf,pxcoord_t ulx,pxcoord_t uly,pxcoord_t lrx,pxcoord_t lry, 
				     uint *membuf,int cnt,int colorspace,int colormap,int iomode,int iodata); 
