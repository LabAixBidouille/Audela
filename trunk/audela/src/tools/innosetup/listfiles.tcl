...
# Auteur : Alain KLOTZ
# Date de MAJ : 26 avril 2006
#
# source c:/d/audela-1.4.0/audela/src/tools/innosetup/listfiles.tcl
   ...
   proc analdir { base } {
      ...
      set base c:/d/audela-1.4.0/audela
      global tab result resultfile f base0
      set base0 "$base"
      set tab 0
      if {$base=="."} {
      ...
      set resultfile "${base}/src/tools/innosetup/audela-1.4.0.iss"
...
append result "AppVerName=Audela-1.4.0\n"
...
append result "DefaultDirName=C:\\audela-1.4.0\n"
