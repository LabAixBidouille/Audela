 ...
 */
#define CAM_ENTRYPOINT Ascomcam_Init
 ...
 */
#define CAM_LIBNAME "libascomcam"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "ascomcam"

#define CAM_INI ascomcam_cam_ini
#define CAM_DRV ascomcam_drv
