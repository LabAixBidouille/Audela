 ...
 */
#define CAM_ENTRYPOINT Oscadine_Init
 ...
 */
#define CAM_LIBNAME "liboscadine"
#define CAM_LIBVER "1.0"

/*
 * Initialisation d'informations indispensables pour la librairie xx.
 */
#define CAM_DRIVNAME "oscadine"

#define CAM_DRV oscadine_cam_drv
#define CAM_INI oscadine_cam_ini
